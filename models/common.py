...
class ASFFV5(nn.Module):
    def __init__(self, level,out,multiplier=1, rfb=False, vis=False, act_cfg=True):
        ...
        self.dim = [int(1024*multiplier), int(512*multiplier),
                    int(256*multiplier),int(256*multiplier)]
        # print(self.dim)
    ...
    def forward(self, x): #l,m,s,t
        """
        # 128, 256, 512
        512, 256, 128
        from small -> large
        """
        x_level_0=x[3] #l    stride 20
        x_level_1=x[2] #m    stride 40
        x_level_2=x[1] #s    stride 80
        x_level_3=x[0] #t    stride 160
